...
const getVueApp = (props = {}, sourceType) => {
    ...
    if (deps !== null && component !== null) {
        imports += `import ${component} from '@fcbtech/primevue/${component.toLowerCase()}';
`;
...
import AnimateOnScroll from '@fcbtech/primevue/animateonscroll';
...
import CascadeSelect from '@fcbtech/primevue/cascadeselect';
import Carousel from '@fcbtech/primevue/carousel';
import Checkbox from '@fcbtech/primevue/checkbox';
import Chip from '@fcbtech/primevue/chip';
import Chips from '@fcbtech/primevue/chips';
import ColorPicker from '@fcbtech/primevue/colorpicker';
import Column from '@fcbtech/primevue/column';
import ColumnGroup from '@fcbtech/primevue/columngroup';
import ConfirmDialog from '@fcbtech/primevue/confirmdialog';
import ConfirmPopup from '@fcbtech/primevue/confirmpopup';
import ConfirmationService from '@fcbtech/primevue/confirmationservice';
import ContextMenu from '@fcbtech/primevue/contextmenu';
import DataTable from '@fcbtech/primevue/datatable';
import DataView from '@fcbtech/primevue/dataview';
import DataViewLayoutOptions from '@fcbtech/primevue/dataviewlayoutoptions';
import DeferredContent from '@fcbtech/primevue/deferredcontent';
import Dialog from '@fcbtech/primevue/dialog';
import DialogService from '@fcbtech/primevue/dialogservice'
import Divider from '@fcbtech/primevue/divider';
import Dock from '@fcbtech/primevue/dock';
...
import Panel from '@fcbtech/primevue/panel';
import PanelMenu from '@fcbtech/primevue/panelmenu';
import Password from '@fcbtech/primevue/password';
import PickList from '@fcbtech/primevue/picklist';
import ProgressBar from '@fcbtech/primevue/progressbar';
import ProgressSpinner from '@fcbtech/primevue/progressspinner';
import Rating from '@fcbtech/primevue/rating';
import RadioButton from '@fcbtech/primevue/radiobutton';
import Ripple from '@fcbtech/primevue/ripple';
import Row from '@fcbtech/primevue/row';
import SelectButton from '@fcbtech/primevue/selectbutton';
import ScrollPanel from '@fcbtech/primevue/scrollpanel';
import ScrollTop from '@fcbtech/primevue/scrolltop';
import Skeleton from '@fcbtech/primevue/skeleton';
import Slider from '@fcbtech/primevue/slider';
import Sidebar from '@fcbtech/primevue/sidebar';
import SpeedDial from '@fcbtech/primevue/speeddial';
...
import Textarea from '@fcbtech/primevue/textarea';
import Toast from '@fcbtech/primevue/toast';
import ToastService from '@fcbtech/primevue/toastservice';
import Toolbar from '@fcbtech/primevue/toolbar';
import TabView from '@fcbtech/primevue/tabview';
import TabPanel from '@fcbtech/primevue/tabpanel';
import Tag from '@fcbtech/primevue/tag';
import Terminal from '@fcbtech/primevue/terminal';
import Timeline from '@fcbtech/primevue/timeline';
import ToggleButton from '@fcbtech/primevue/togglebutton';
import Tooltip from '@fcbtech/primevue/tooltip';
import Tree from '@fcbtech/primevue/tree';
import TreeSelect from '@fcbtech/primevue/treeselect';
import TreeTable from '@fcbtech/primevue/treetable';
import TriStateCheckbox from '@fcbtech/primevue/tristatecheckbox';
